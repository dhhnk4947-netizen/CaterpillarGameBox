...
After enabling the extension, click `Panel -> hotfix-builder -> Default Panel` in the main menu bar to open the default panel of the extension.

To send a message to the default panel, click `Developer -> hotfix-builder -> Send Message to Panel` at the top of the menu. If the default panel
