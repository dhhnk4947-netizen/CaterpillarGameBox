System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, easing, Node, Quat, size, tween, Tween, UITransform, FullView, onMount, Path, _dec, _dec2, _dec3, _dec4, _dec5, _dec6, _dec7, _dec8, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _descriptor5, _descriptor6, _crd, ccclass, property, HallView;
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "ba2e4Q3CJNKB6pf5gC5K2Kd", "HallView", undefined);

      __checkObsolete__(['_decorator', 'Component', 'director', 'easing', 'game', 'Node', 'Quat', 'quat', 'size', 'tween', 'Tween', 'UITransform', 'v3']);
      ...
      _export("HallView", HallView = (_dec = ccclass('HallView'), _dec2 = (_crd && Path === void 0 ? (_reportPossibleCrUseOfPath({
        ...
        error: Error()
      }), Path) : Path)('btns/SettingBtn'), _dec7 = (_crd && Path === void 0 ? (_reportPossibleCrUseOfPath({
        error: Error()
      }), Path) : Path)('Mask', UITransform), _dec8 = _crd && onMount === void 0 ? (_reportPossibleCrUseOfonMount({
        error: Error()
        ...
        constructor(...args) {
          ...
          _initializerDefineProperty(this, "animNode", _descriptor6, this);
        }
        ...
        titleStartAnim() {
          ...
          let t = tween(this.titleNode).to(1.5, {
      ...
      }), _applyDecoratedDescriptor(_class2.prototype, "mount", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "mount"), _class2.prototype)), _class2)) || _class));
...
//# sourceMappingURL=b266abe6e5c8a004a35569a0ce4a91a645ece924.js.map